#!/usr/bin/env python3
"""
B370 — Crear JUVENTUS VISITANTE TIPO ORIGINAL
==============================================
Flujo completo:
...
Datos de Quenti (CUENTI INVENTARIO 6 ABRIL.xlsx):
  XXL → SKU: 2100001034004 | stock: 1 | Quenti ID 2667
  S   → sin SKU            | stock: 0 | sin registro en Quenti
  M   → sin SKU            | stock: 0 | sin registro en Quenti
  L   → sin SKU            | stock: 0 | sin registro en Quenti
  XL  → sin SKU            | stock: 0 | sin registro en Quenti
...
PRODUCTO = {
    "nombre_wc":     "JUVENTUS VISITANTE TIPO ORIGINAL",
    "nombre_imagen": "JUVENTUS-VISITANTE-TIPO-ORIGINAL",
    "calidad":       "Tipo original",
    "tallas":        ["S", "M", "L", "XL", "XXL"],
    "precio":        139900,
    "categoria_id":  100,
    "categoria":     "Juventus",
    # SKUs de Quenti (codigo de barras). None = sin SKU
    "skus": {
        "S":   None,
        "M":   None,
        "L":   None,
...
def main():
    print("\n" + "=" * 62)
    print("  B370 — JUVENTUS VISITANTE TIPO ORIGINAL")
