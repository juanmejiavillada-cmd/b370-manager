#!/usr/bin/env python3
"""
B370 — Crear INTER DE MILAN VISITANTE TIPO ORIGINAL
====================================================
Flujo completo:
  1. Verificar que el producto no exista en WC
  2. Subir 4 imagenes via SCP al servidor
...
Datos de Quenti (CUENTI INVENTARIO 6 ABRIL.xlsx):
  XXL -> SKU: 2100001033908 | stock: 1 | Quenti ID 2660
  S   -> sin SKU            | stock: 0
  M   -> sin SKU            | stock: 0
  L   -> sin SKU            | stock: 0
  XL  -> sin SKU            | stock: 0

Categoria WooCommerce: INTER DE MILAN (ID 89)
...
PRODUCTO = {
    "nombre_wc":     "Inter de Milan Visitante Tipo Original",
    "nombre_imagen": "INTER-DE-MILAN-VISITANTE-TIPO-ORIGINAL",
    "calidad":       "Tipo original",
    "tallas":        ["S", "M", "L", "XL", "XXL"],
    "precio":        109900,
    "categoria_id":  89,
    "categoria":     "INTER DE MILAN",
...
def main():
    print("\n" + "=" * 62)
    print("  B370 — INTER DE MILAN VISITANTE TIPO ORIGINAL")
