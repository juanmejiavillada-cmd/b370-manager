#!/usr/bin/env python3
"""
B370 — Crear ROMA TIPO ORIGINAL CON DORSAL
==========================================
Flujo completo:
  1. Subir 5 imagenes via SCP al servidor
...
Datos de Quenti (CUENTI INVENTARIO 6 ABRIL.xlsx):
  S   -> SKU: 2100002023403 | stock: 0
  M   -> SKU: 2100001999907 | stock: 0
  L   -> SKU: 2100002023502 | stock: 0
  XL  -> SKU: 2100002023601 | stock: 0
  XXL -> SKU: 2100000981408 | stock: 1
...
PRODUCTO = {
    "nombre_wc":     "ROMA TIPO ORIGINAL CON DORSAL",
    "nombre_imagen": "ROMA-TIPO-ORIGINAL-CON-DORSAL",
...
def main():
    print("\n" + "=" * 62)
    print("  B370 - ROMA TIPO ORIGINAL CON DORSAL")
    ...
    if faltantes:
        ...
        print("  Para agregar imagenes luego: coloca los archivos en imagenes/para-subir/")
        print("  y ejecuta el script de asignacion de imagenes.")
        print()
        imagen_ids_usados = []
        skip_imagenes = True
    else:
    ...
    # Conectar SSH (siempre necesario para importar imagenes si hay, y para asignar)
    ...
    print(f"{'='*62}")
    if not imagen_ids_usados:
        print()
        print("  PENDIENTE: Subir 5 imagenes a imagenes/para-subir/:")
        for i in range(1, N_IMAGENES + 1):
            print(f"    - ROMA-TIPO-ORIGINAL-CON-DORSAL_{i}.jpg")
        print("  Luego ejecutar script de asignacion de imagenes.")
    print(f"{'='*62}")
